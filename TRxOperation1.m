...
%downlink
[posS,velS,dt1]=getPreciseSatPosVel_r(ToA+0.16/86400,svID,RxSite,'downlink');
% t1=addSeconds(t0,0.16);
% [posSx,velSx,dt1]=actualtof(t1,satIDs,TxSite,'uplink');
[posS1,velS1,~]=getPreciseSatPosVel_r(ToA+0.25/86400,svID,RxSite,'downlink');
